...
function App() {
  ...
  /*El "prev" y el "next" que estamos usando, aparece en la API de Rick y Morty */
  /*El "info.prev" y el "info.next" que estamos usando, aparece en la API de Rick y Morty */

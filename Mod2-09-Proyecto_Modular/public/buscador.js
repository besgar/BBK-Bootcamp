function buscar(){
    let dificultadBuscar=document.getElementById("dificultad").value;
    fetch("/recetas/buscardificultad/" + dificultadBuscar).then(function(res){
        return res.json();
    }).then(function(datos){
        let recetas="";
...
function buscarPlato(){
    let platoBuscar=document.getElementById("platoBuscar").value;
    fetch("/recetas/buscarplato/" + platoBuscar).then(function(res){
        return res.json();
    }).then(function(datos){
        let recetas="";
        let filaCuatroRecetas=1;
...
function buscarNombre(){
    ...
    fetch("/recetas/buscarpalabra/" + nombreBuscar).then(function(res){
        return res.json();
    }).then(function(datos){
        let recetas="";
        let filaCuatroRecetas=1;

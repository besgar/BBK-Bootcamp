...
function MostrarDetallesContacto(){
  ...
  function refreshPage() {
    ...
    // function eliminarInsignia(emailContacto){

    //   const requestOptions2 = {
    //       method: 'PUT',
    //       headers: { 'Content-Type': 'application/json' },
    //       body: JSON.stringify({ usuario: "elenabestilleiro@gmail.com", contacto: emailContacto, nombreInsignia: nombreinsig})
    //   };
          ...
          <div>
            <Card style={{ width: '300px' }}>
              ...
              <Card.Body>
                ...
                {/* <Button className="btn-round" color="danger" onClick={eliminarInsignia(contactoPersona.email)}><i className="nc-icon nc-simple-remove"/> Quitar insignia</Button> */}

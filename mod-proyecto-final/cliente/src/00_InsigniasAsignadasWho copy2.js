...
function MostrarDetallesContacto(){
    ...
    function eliminarInsignia(){
      const requestOptions2 = {
          ...
          body: JSON.stringify({ usuario: "elenabestilleiro@gmail.com", contacto: "ama@mail.com", nombreInsignia: nombreinsig})
      };
          ...
          <div>
            <Card style={{ width: '300px' }}>
              ...
              <Card.Body>
                ...
                <Button className="btn-round" color="danger" onClick={eliminarInsignia}><i className="nc-icon nc-simple-remove"/> Quitar insignia</Button>
              </Card.Body>
            </Card>
        </div>
        </>

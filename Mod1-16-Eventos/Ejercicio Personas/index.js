...
// 		persona = `
// 		<div style="background-color : ${arrayPersonas[valor].colorOjos}" class="persona-container">
// 			<img src="${arrayPersonas[valor].imagen}" alt="imagen"/>
// 			<h1>${arrayPersonas[valor].nombre}</h1>
// 			<p>EDAD: ${arrayPersonas[valor].edad}</p>
// 			<p>E-MAIL: ${arrayPersonas[valor].email}</p>
// 			<p>DIRECCIÓN: ${arrayPersonas[valor].direccion}</p>
// 		</div>
// 		`;
// 		document.getElementById("divpersona").innerHTML = persona;
// 	}else{
// 		document.getElementById("divpersona").innerHTML = "<p>No existe ningún usuario con ese número</p>";
// 	}
// }
...
function buscarPersonas(){
			...
			if(arrayPersonas[i].nombre.includes(valor)){
				mostrarPersonas+=`
					<div style="background-color : ${arrayPersonas[i].colorOjos}" class="persona-container">
						<img src="${arrayPersonas[i].imagen}" alt="imagen"/>
						<h1>${arrayPersonas[i].nombre}</h1>
						<p>EDAD: ${arrayPersonas[i].edad}</p>
						<p>E-MAIL: ${arrayPersonas[i].email}</p>
						<p>DIRECCIÓN: ${arrayPersonas[i].direccion}</p>
					</div>
				`;
			}else{
				document.getElementById("divpersona").innerHTML = "<p>No existe ningún usuario con con esos caracteres</p>";
			}
		}
	}else{
		for(let i=0; i<arrayPersonas.length; i++){
	...
	document.getElementById("divpersona").innerHTML = mostrarPersonas;
}
